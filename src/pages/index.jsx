...
const PRINCIPLES = [
  ['天然植物，科學驗方', '寵悅康TM 採用嚴格篩選的天然植物萃取，結合大學生物科學研發，確保每款保健配方具備最高的安全性與效用。寵悅康TM 系列不含人工防腐劑、合成香料及有害化學物質，獨立滴管設計保障每次使用的衛生標準，讓毛孩以最溫和的方式獲得最有效的護理。'],
  ['科研實證 信賴品質', '寵悅康TM 產品系列經大學科研測試與實際案例驗證，涵蓋眼部、肝臟、腎臟、免疫力及耳部等多個護理領域。每個成功個案都是我們持續進步的動力，更是家長對品牌信任的最佳見證，讓科學數據說話，為毛孩健康護航。'],
      ...
      <div className="space-y-20 pb-0">
        <section className="grid overflow-hidden bg-cyberPanelSoft lg:grid-cols-[1.05fr_0.95fr]">
          <div className="flex items-center px-7 py-16 sm:px-12 lg:px-16 lg:py-24">
            <div className="max-w-xl">
              ...
              <p className="mt-6 max-w-lg text-base leading-8 text-cyberGray">寵悅康<sup className="text-xs">TM</sup> 創辦人 Dr. Lai - 自然療法醫學博士，自 2007 年起研發天然植物萃取物結合現代科研實證，開拓安全有效的整全天然護理系列。</p>
            </div>
          </div>
          <img className="h-full min-h-[380px] w-full object-contain bg-cyberPanelSoft" src="/demo/IMG_4355 (1).jpeg" alt="被安心照顧的貓咪" />
        </section>
        ...
        <section id="story" className="grid gap-10 px-2 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="border-l-2 border-cyberPurple pl-6 text-base leading-8 text-cyberGray sm:pl-8">
            <p>寵悅康<sup className="text-xs">TM</sup> 的創立，源於創辦人對毛孩深切的愛護之情。她深信每一隻毛孩都應享有高品質、安全有效、不含副作用的天然護理。</p>
            <p className="mt-5">多年來，創辦人堅守使命，持續以實證科研開拓草本抗氧化驗方，為無數毛孩家庭帶來真實改變，守護毛孩的健康生活。</p>
          </div>
        </section>
        ...
        <section className="bg-cyberPanelDeep px-7 py-14 sm:px-12 lg:px-16">
          ...
          <h2 className="mt-3 max-w-2xl text-3xl font-extrabold leading-tight text-cyberBlack sm:text-4xl">天然與科學<br />為毛孩穩定健康的支柱</h2>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <ol className="mt-5 max-w-3xl space-y-3 text-sm leading-7 text-white/75">
                <li>1. 香港各大授權代理商及指定寵物用品店均有銷售，請認明官方標誌，確保購買正品。</li>
